...
This script deploys the Accio Brain Agent stack with different configurations:
...
def main():
    parser = argparse.ArgumentParser(
        description='Deploy the Accio Brain Agent stack',
...
Examples:
  ...
  python deploy.py --down --type cloud
    ...
    parser.add_argument(
        ...
        choices=['local', 'cloud'], 
        required=True,
        help='Deployment type: local (join Accio Brain stack) or cloud (standalone)'
    )
    
    parser.add_argument(
        '--project', 
        default='accio-brain',
        help='Docker Compose project name (default: accio-brain)'
    )
