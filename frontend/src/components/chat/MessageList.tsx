    ...
    return (
      <div className="flex-1 flex flex-col items-center justify-center p-6 h-full">
        <div className="max-w-md text-center">
          <h3 className="text-xl font-bold mb-2">Welcome to ACCIO's Brain</h3>
          ...
          <div className="grid gap-2 text-sm">
            ...
            <div className="bg-secondary/50 p-3 rounded-md">
              What research capabilities do you have available?
            </div>
            <div className="bg-secondary/50 p-3 rounded-md">
              What documents do you have access to?
            </div>
            <div className="bg-secondary/50 p-3 rounded-md">
              Tell me about Diego Feitt, CEO of Accio, or about Accio company
            </div>
          </div>
        </div>
      </div>
