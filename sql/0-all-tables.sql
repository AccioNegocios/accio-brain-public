...
GRANT INSERT, UPDATE, DELETE ON TABLE messages TO authenticated;
GRANT INSERT, UPDATE, DELETE ON TABLE user_profiles TO authenticated;
GRANT INSERT, UPDATE, DELETE ON TABLE conversations TO authenticated;

-- Grant access to service_role users
GRANT ALL PRIVILEGES ON TABLE messages TO service_role;
GRANT ALL PRIVILEGES ON TABLE requests TO service_role;
GRANT ALL PRIVILEGES ON TABLE conversations TO service_role;
GRANT ALL PRIVILEGES ON TABLE documents TO service_role;
GRANT ALL PRIVILEGES ON TABLE document_metadata TO service_role;
GRANT ALL PRIVILEGES ON TABLE document_rows TO service_role;
